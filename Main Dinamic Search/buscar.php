...
$query = "SELECT DISTINCT Curso FROM alumnus_main_table WHERE Tipo = 'grado-universitario' ORDER By ID"; //and Cliente = 1

//buscador general busca entre todas las tablas

if(isset($_POST['consulta'])){
  $q = $mysqli->real_escape_string($_POST['consulta']);
  $query = "SELECT DISTINCT Curso FROM alumnus_main_table WHERE Curso LIKE '%".$q."%'";
